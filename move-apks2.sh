...
APKS_DST=(
    ...
    # Nappa Greedy
    "${PROJECT_DIR}/build/apks/instrumented-nappa-greedy/nappagreedy.de.danoeh.antennapod.debug.apk"
    "${PROJECT_DIR}/build/apks/instrumented-nappa-greedy/nappagreedy.appteam.nith.hillffair.apk"
    "${PROJECT_DIR}/build/apks/instrumented-nappa-greedy/nappagreedy.io.github.hidroh.materialistic.apk"
    "${PROJECT_DIR}/build/apks/instrumented-nappa-greedy/nappagreedy.com.newsblur.apk"
    "${PROJECT_DIR}/build/apks/instrumented-nappa-greedy/nappagreedy.org.quantumbadger.redreader.apk"
    "${PROJECT_DIR}/build/apks/instrumented-nappa-greedy/nappagreedy.io.github.project_travel_mate.apk"
    "${PROJECT_DIR}/build/apks/instrumented-nappa-greedy/nappagreedy.com.ak.uobtimetable.apk"
    # Nappa TFPR
    "${PROJECT_DIR}/build/apks/instrumented-nappa-tfpr/nappatfpr.de.danoeh.antennapod.debug.apk"
    "${PROJECT_DIR}/build/apks/instrumented-nappa-tfpr/nappatfpr.appteam.nith.hillffair.apk"
    "${PROJECT_DIR}/build/apks/instrumented-nappa-tfpr/nappatfpr.io.github.hidroh.materialistic.apk"
    "${PROJECT_DIR}/build/apks/instrumented-nappa-tfpr/nappatfpr.com.newsblur.apk"
    "${PROJECT_DIR}/build/apks/instrumented-nappa-tfpr/nappatfpr.org.quantumbadger.redreader.apk"
    "${PROJECT_DIR}/build/apks/instrumented-nappa-tfpr/nappatfpr.io.github.project_travel_mate.apk"
    "${PROJECT_DIR}/build/apks/instrumented-nappa-tfpr/nappatfpr.com.ak.uobtimetable.apk"
    # PALOMA
