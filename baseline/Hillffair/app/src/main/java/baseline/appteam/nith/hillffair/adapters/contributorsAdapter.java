package baseline.appteam.nith.hillffair.adapters;
...
import baseline.appteam.nith.hillffair.models.contributorsItem;
...
public class contributorsAdapter extends RecyclerView.Adapter<contributorsAdapter.ViewHolder>{
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.contributor_cardview,parent,false);
