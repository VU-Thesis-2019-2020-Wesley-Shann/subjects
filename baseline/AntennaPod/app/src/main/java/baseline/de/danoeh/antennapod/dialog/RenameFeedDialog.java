package baseline.de.danoeh.antennapod.dialog;
...
public class RenameFeedDialog {
    ...
    public void show() {
        ...
        new MaterialDialog.Builder(activity)
                .title(baseline.de.danoeh.antennapod.core.R.string.rename_feed_label)
                ...
                .neutralText(baseline.de.danoeh.antennapod.core.R.string.reset)
                .onNeutral((dialog, which) -> dialog.getInputEditText().setText(feed.getFeedTitle()))
                .negativeText(baseline.de.danoeh.antennapod.core.R.string.cancel_label)
