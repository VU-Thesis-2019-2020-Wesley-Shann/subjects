package baseline.de.danoeh.antennapod.preferences;
...
import baseline.de.danoeh.antennapod.CrashReportWriter;
import baseline.de.danoeh.antennapod.R;
import baseline.de.danoeh.antennapod.activity.AboutActivity;
import baseline.de.danoeh.antennapod.activity.DirectoryChooserActivity;
import baseline.de.danoeh.antennapod.activity.ImportExportActivity;
import baseline.de.danoeh.antennapod.activity.MainActivity;
import baseline.de.danoeh.antennapod.activity.MediaplayerActivity;
import baseline.de.danoeh.antennapod.activity.OpmlImportFromPathActivity;
import baseline.de.danoeh.antennapod.activity.PreferenceActivity;
import baseline.de.danoeh.antennapod.activity.StatisticsActivity;
import baseline.de.danoeh.antennapod.asynctask.ExportWorker;
import baseline.de.danoeh.antennapod.core.export.ExportWriter;
import baseline.de.danoeh.antennapod.core.export.html.HtmlWriter;
import baseline.de.danoeh.antennapod.core.export.opml.OpmlWriter;
...
import baseline.de.danoeh.antennapod.core.service.GpodnetSyncService;
import baseline.de.danoeh.antennapod.core.util.flattr.FlattrUtils;
import baseline.de.danoeh.antennapod.core.util.gui.PictureInPictureUtil;
import baseline.de.danoeh.antennapod.dialog.AuthenticationDialog;
import baseline.de.danoeh.antennapod.dialog.AutoFlattrPreferenceDialog;
import baseline.de.danoeh.antennapod.dialog.ChooseDataFolderDialog;
import baseline.de.danoeh.antennapod.dialog.GpodnetSetHostnameDialog;
import baseline.de.danoeh.antennapod.dialog.ProxyDialog;
import baseline.de.danoeh.antennapod.dialog.VariableSpeedDialog;
import baseline.de.danoeh.antennapod.preferences.PreferenceControllerFlavorHelper;
import io.reactivex.Observable;
import io.reactivex.android.schedulers.AndroidSchedulers;
import io.reactivex.disposables.Disposable;
import io.reactivex.schedulers.Schedulers;

import static baseline.de.danoeh.antennapod.activity.PreferenceActivity.PARAM_RESOURCE;
