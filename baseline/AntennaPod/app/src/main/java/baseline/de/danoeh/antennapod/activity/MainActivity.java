...
import baseline.de.danoeh.antennapod.fragment.AddFeedFragment;
import baseline.de.danoeh.antennapod.fragment.DownloadsFragment;
import baseline.de.danoeh.antennapod.fragment.EpisodesFragment;
import baseline.de.danoeh.antennapod.fragment.ExternalPlayerFragment;
import baseline.de.danoeh.antennapod.fragment.ItemlistFragment;
import baseline.de.danoeh.antennapod.fragment.PlaybackHistoryFragment;
import baseline.de.danoeh.antennapod.fragment.QueueFragment;
import baseline.de.danoeh.antennapod.fragment.SubscriptionFragment;
import baseline.de.danoeh.antennapod.menuhandler.NavDrawerActivity;
import baseline.de.danoeh.antennapod.R;
import baseline.de.danoeh.antennapod.adapter.NavListAdapter;
...
import baseline.de.danoeh.antennapod.core.event.ProgressEvent;
import baseline.de.danoeh.antennapod.core.event.QueueEvent;
...
import baseline.de.danoeh.antennapod.core.util.Flavors;
import baseline.de.danoeh.antennapod.core.util.IntentUtils;
import baseline.de.danoeh.antennapod.core.util.StorageUtils;
import baseline.de.danoeh.antennapod.core.util.download.AutoUpdateManager;
import baseline.de.danoeh.antennapod.core.util.gui.NotificationUtils;
import baseline.de.danoeh.antennapod.dialog.RatingDialog;
