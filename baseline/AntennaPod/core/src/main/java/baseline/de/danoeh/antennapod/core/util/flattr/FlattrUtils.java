package baseline.de.danoeh.antennapod.core.util.flattr;
...
import baseline.de.danoeh.antennapod.core.asynctask.FlattrTokenFetcher;
...
public class FlattrUtils {
    ...
    private static final String HOST_NAME = "baseline.de.danoeh.antennapod";

    private static final String PREF_ACCESS_TOKEN = "baseline.de.danoeh.antennapod.preference.flattrAccessToken";
