package baseline.de.danoeh.antennapod.core.service.playback;
...
import baseline.de.danoeh.antennapod.core.R;
import baseline.de.danoeh.antennapod.core.event.MessageEvent;
import baseline.de.danoeh.antennapod.core.event.ServiceEvent;
...
import baseline.de.danoeh.antennapod.core.feed.SearchResult;
import baseline.de.danoeh.antennapod.core.glide.ApGlideSettings;
import baseline.de.danoeh.antennapod.core.preferences.PlaybackPreferences;
import baseline.de.danoeh.antennapod.core.preferences.SleepTimerPreferences;
import baseline.de.danoeh.antennapod.core.preferences.UserPreferences;
import baseline.de.danoeh.antennapod.core.receiver.MediaButtonReceiver;
import baseline.de.danoeh.antennapod.core.service.PlayerWidgetJobService;
...
import baseline.de.danoeh.antennapod.core.storage.FeedSearcher;
import baseline.de.danoeh.antennapod.core.util.IntentUtils;
import baseline.de.danoeh.antennapod.core.util.QueueAccess;
...
public class PlaybackService extends MediaBrowserServiceCompat {
     ...
     */
    public static final String EXTRA_CAST_DISCONNECT = "extra.baseline.de.danoeh.antennapod.core.service.castDisconnect";
    /**
     * True if media should be streamed.
     */
    public static final String EXTRA_SHOULD_STREAM = "extra.baseline.de.danoeh.antennapod.core.service.shouldStream";
    /**
     * True if playback should be started immediately after media has been
     * prepared.
     */
    public static final String EXTRA_START_WHEN_PREPARED = "extra.baseline.de.danoeh.antennapod.core.service.startWhenPrepared";

    public static final String EXTRA_PREPARE_IMMEDIATELY = "extra.baseline.de.danoeh.antennapod.core.service.prepareImmediately";

    public static final String ACTION_PLAYER_STATUS_CHANGED = "action.baseline.de.danoeh.antennapod.core.service.playerStatusChanged";
    ...
    public static final String ACTION_PLAYER_NOTIFICATION = "action.baseline.de.danoeh.antennapod.core.service.playerNotification";
    public static final String EXTRA_NOTIFICATION_CODE = "extra.baseline.de.danoeh.antennapod.core.service.notificationCode";
    public static final String EXTRA_NOTIFICATION_TYPE = "extra.baseline.de.danoeh.antennapod.core.service.notificationType";

    /**
     * If the PlaybackService receives this action, it will stop playback and
     * try to shutdown.
     */
    public static final String ACTION_SHUTDOWN_PLAYBACK_SERVICE = "action.baseline.de.danoeh.antennapod.core.service.actionShutdownPlaybackService";
     ...
     */
    public static final String ACTION_SKIP_CURRENT_EPISODE = "action.baseline.de.danoeh.antennapod.core.service.skipCurrentEpisode";

    /**
     * If the PlaybackService receives this action, it will pause playback.
     */
    public static final String ACTION_PAUSE_PLAY_CURRENT_EPISODE = "action.baseline.de.danoeh.antennapod.core.service.pausePlayCurrentEpisode";


    /**
     * If the PlaybackService receives this action, it will resume playback.
     */
    public static final String ACTION_RESUME_PLAY_CURRENT_EPISODE = "action.baseline.de.danoeh.antennapod.core.service.resumePlayCurrentEpisode";

    /**
     * Custom action used by Android Wear
     */
    private static final String CUSTOM_ACTION_FAST_FORWARD = "action.baseline.de.danoeh.antennapod.core.service.fastForward";
    private static final String CUSTOM_ACTION_REWIND = "action.baseline.de.danoeh.antennapod.core.service.rewind";
