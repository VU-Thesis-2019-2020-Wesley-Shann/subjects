package baseline.de.danoeh.antennapod.core.util.id3reader;
...
import baseline.de.danoeh.antennapod.core.feed.ID3Chapter;
import baseline.de.danoeh.antennapod.core.util.id3reader.model.FrameHeader;
import baseline.de.danoeh.antennapod.core.util.id3reader.model.TagHeader;
