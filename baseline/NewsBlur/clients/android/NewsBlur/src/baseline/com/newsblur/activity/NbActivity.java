...
public class NbActivity extends FragmentActivity {
	...
	protected void onCreate(Bundle bundle) {
        ...
        if (PrefsUtils.getUserId(this) == null) {
            baseline.com.newsblur.util.Log.e(this, "post-login activity launched without valid login.");
	...
	protected void onPause() {
        baseline.com.newsblur.util.Log.d(this.getClass().getName(), "onPause");
		super.onPause();
	...
	protected void finishIfNotLoggedIn() {
		...
		if(currentLoginKey == null || !currentLoginKey.equals(uniqueLoginKey)) {
			baseline.com.newsblur.util.Log.d(this.getClass().getName(), "This activity was for a different login. finishing it.");
			finish();
		}
	}
	...
	protected void onSaveInstanceState(Bundle savedInstanceState) {
        baseline.com.newsblur.util.Log.d(this, "onSave");
    ...
    protected void handleUpdate(int updateType) {
        baseline.com.newsblur.util.Log.w(this, "activity doesn't implement handleUpdate");
    }
