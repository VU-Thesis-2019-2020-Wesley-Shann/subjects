...
import baseline.com.newsblur.activity.AllSharedStoriesItemsList;
import baseline.com.newsblur.activity.AllStoriesItemsList;
import baseline.com.newsblur.activity.FeedItemsList;
import baseline.com.newsblur.activity.FolderItemsList;
import baseline.com.newsblur.activity.GlobalSharedStoriesItemsList;
import baseline.com.newsblur.activity.InfrequentItemsList;
import baseline.com.newsblur.activity.ItemsList;
import baseline.com.newsblur.activity.Main;
import baseline.com.newsblur.activity.NbActivity;
import baseline.com.newsblur.activity.ReadStoriesItemsList;
import baseline.com.newsblur.activity.SavedStoriesItemsList;
import baseline.com.newsblur.activity.SocialFeedItemsList;
import baseline.com.newsblur.database.FolderListAdapter;
...
public class FolderListFragment extends NbFragment implements OnCreateContextMenuListener, 
	...
	public void hasUpdated() {
        if (isAdded()) {
            baseline.com.newsblur.util.Log.d(this, "loading feeds in mode: " + currentState);
            try {
    ...
    public void pushUnreadCounts() {
        ...
        baseline.com.newsblur.util.Log.d(this, "showing " + adapter.lastFeedCount + " feeds");
    }
