...
import baseline.com.newsblur.database.ReadingAdapter;
import baseline.com.newsblur.domain.Story;
import baseline.com.newsblur.fragment.ReadingItemFragment;
import baseline.com.newsblur.fragment.ReadingPagerFragment;
import baseline.com.newsblur.service.NBSyncService;
...
import baseline.com.newsblur.util.PrefConstants.ThemeValue;
import baseline.com.newsblur.util.PrefsUtils;
import baseline.com.newsblur.util.ReadingFontChangedListener;
import baseline.com.newsblur.util.StateFilter;
import baseline.com.newsblur.util.UIUtils;
import baseline.com.newsblur.util.ViewUtils;
import baseline.com.newsblur.util.VolumeKeyNavigation;
import baseline.com.newsblur.view.ReadingScrollView.ScrollChangeListener;
...
public abstract class Reading extends NbActivity implements OnPageChangeListener, OnSeekBarChangeListener, ScrollChangeListener, LoaderManager.LoaderCallbacks<Cursor>, ReadingFontChangedListener {
	...
	protected void onCreate(Bundle savedInstanceBundle) {
        ...
        try {
            ...
            // Serializable extras.
            baseline.com.newsblur.util.Log.e(this, "failed to unfreeze required extras", re);
            finish();
            return;
        }

        if (fs == null) {
            baseline.com.newsblur.util.Log.w(this.getClass().getName(), "reading view had no FeedSet");
            finish();
            return;
        }
	...
	public void onLoadFinished(Loader<Cursor> loader, Cursor cursor) {
        synchronized (STORIES_MUTEX) {
            ...
            if (! FeedUtils.dbHelper.isFeedSetReady(fs)) {
                baseline.com.newsblur.util.Log.i(this.getClass().getName(), "stale load");
            ...
            baseline.com.newsblur.util.Log.d(this.getClass().getName(), "loaded cursor with count: " + cursor.getCount());
