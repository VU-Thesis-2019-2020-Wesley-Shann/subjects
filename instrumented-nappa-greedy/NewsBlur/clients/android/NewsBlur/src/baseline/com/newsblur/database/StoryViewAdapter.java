...
import baseline.com.newsblur.fragment.StoryIntelTrainerFragment;
import baseline.com.newsblur.util.FeedSet;
import baseline.com.newsblur.util.FeedUtils;
import baseline.com.newsblur.util.GestureAction;
import baseline.com.newsblur.util.ImageLoader;
...
public class StoryViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private void thawDiffUpdate(final Cursor c, final RecyclerView rv) {
        ...
        try {
            ...
            baseline.com.newsblur.util.Log.e(this, "error thawing story list: " + e.getMessage(), e);
            return;
        }
