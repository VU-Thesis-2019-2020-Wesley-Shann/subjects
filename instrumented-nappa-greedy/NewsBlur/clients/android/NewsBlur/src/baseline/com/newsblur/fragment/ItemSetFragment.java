...
import baseline.com.newsblur.database.StoryViewAdapter;
...
import baseline.com.newsblur.util.StoryListStyle;
import baseline.com.newsblur.util.UIUtils;
import baseline.com.newsblur.util.ViewUtils;
import baseline.com.newsblur.view.ProgressThrobber;
...
public class ItemSetFragment extends NbFragment implements LoaderManager.LoaderCallbacks<Cursor> {
	...
	public Loader<Cursor> onCreateLoader(int arg0, Bundle arg1) {
        ...
        if (fs == null) {
            baseline.com.newsblur.util.Log.e(this.getClass().getName(), "can't create fragment, no feedset ready");
    ...
    private void ensureSufficientStories() {
        ...
        //baseline.com.newsblur.util.Log.d(this, String.format(" total:%d  bound:%d  last%d  desire:%d", totalCount, visibleCount, lastVisible, desiredStoryCount));
    }
