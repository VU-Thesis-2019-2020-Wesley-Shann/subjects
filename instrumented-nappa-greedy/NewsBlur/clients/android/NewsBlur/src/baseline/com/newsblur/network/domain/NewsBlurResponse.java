...
public class NewsBlurResponse {
    ...
    public boolean isError() {
        ...
        if ((message != null) && (!message.equals("")) && (!message.equals("OK"))) {
            ...
            baseline.com.newsblur.util.Log.d(this.getClass().getName(), "Response interpreted as fatal due to 'message' field: " + message);
            return true;
        }
        if ((errors != null) && (errors.length > 0) && (errors[0] != null)) {
            baseline.com.newsblur.util.Log.d(this.getClass().getName(), "Response interpreted as error due to 'errors' field: " + errors[0]);
            return true;
        }
        return false;
    }
