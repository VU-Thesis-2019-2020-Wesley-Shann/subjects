package baseline.com.newsblur.view;
    ...
    class NewsblurWebViewClient extends WebViewClient {
        ...
        public boolean shouldOverrideUrlLoading(WebView view, String url) {
            ...
            try {
                ...
                baseline.com.newsblur.util.Log.e(this.getClass().getName(), "device cannot open URLs");
            }
            return true;
        }
        ...
        public void onReceivedError (WebView view, WebResourceRequest request, WebResourceError error) {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                baseline.com.newsblur.util.Log.w(this, "WebView Error ("+error.getErrorCode()+"): " + error.getDescription());
            }
    ...
    class NewsblurWebChromeClient extends WebChromeClient {
        ...
        public void onShowCustomView(View view, WebChromeClient.CustomViewCallback callback) {
            if (customViewLayout == null) {
                baseline.com.newsblur.util.Log.w(this, "can't show HTML5 custom view, no container set");
                return;
            }
            if (webviewWrapperLayout == null) {
                baseline.com.newsblur.util.Log.w(this, "can't show HTML5 custom view, no wrapper set");
                return;
            }
            ...
            if (! (view instanceof FrameLayout)) {
                baseline.com.newsblur.util.Log.w(this, "custom view wasn't a FrameLayout");
               // return;
            }
            if (customView != null) {
