...
import baseline.com.newsblur.service.OriginalTextService;
...
import baseline.com.newsblur.util.Font;
import baseline.com.newsblur.util.PrefConstants.ThemeValue;
import baseline.com.newsblur.util.PrefsUtils;
import baseline.com.newsblur.util.StoryUtils;
import baseline.com.newsblur.util.UIUtils;
import baseline.com.newsblur.util.ViewUtils;
import baseline.com.newsblur.view.FlowLayout;
import baseline.com.newsblur.view.NewsblurWebview;
import baseline.com.newsblur.view.ReadingScrollView;
...
public class ReadingItemFragment extends NbFragment implements PopupMenu.OnMenuItemClickListener {
    ...
    public boolean onMenuItemClick(MenuItem item) {
		if (item.getItemId() == R.id.menu_reading_original) {
            ...
            try {
                ...
                baseline.com.newsblur.util.Log.e(this, "device cannot open URLs");
            }
			return true;
    ...
    public void offerStoryUpdate(Story story) {
        ...
        if (! TextUtils.equals(story.storyHash, this.story.storyHash)) {
            baseline.com.newsblur.util.Log.d(this, "prevented story list index offset shift");
            return;
        }
        this.story = story;
        //if (AppConstants.VERBOSE_LOG) baseline.com.newsblur.util.Log.d(this, "got fresh story");
    }
                ...
                protected void onPostExecute(String result) {
                    if (result != null) {
                        if (OriginalTextService.NULL_STORY_TEXT.equals(result)) {
                            ...
                            baseline.com.newsblur.util.Log.d(this, "orig text not avail for story: " + story.storyHash);
                        ...
                        baseline.com.newsblur.util.Log.d(this, "orig text not yet cached for story: " + story.storyHash);
        ...
        new AsyncTask<Void, Void, String>() {
            ...
            protected void onPostExecute(String result) {
                if (result != null) {
                    ...
                    baseline.com.newsblur.util.Log.w(this, "couldn't find story content for existing story.");
