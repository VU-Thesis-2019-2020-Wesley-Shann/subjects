...
public class PrefsUtils {
    ...
    public static boolean checkForUpgrade(Context context) {
        ...
        if ( (oldVersion == null) || (!oldVersion.equals(version)) ) {
            baseline.com.newsblur.util.Log.i(PrefsUtils.class.getName(), "detected new version of app:" + version);
            return true;
        }
        return false;
    ...
    public static void sendLogEmail(Context context) {
        File f = baseline.com.newsblur.util.Log.getLogfile();
        if (f == null) return;
        String debugInfo = "Tell us a bit about your problem:\n\n\n\n" + getDebugInfo(context);
        android.net.Uri localPath = FileProvider.getUriForFile(context, "baseline.com.newsblur.fileprovider", f);
