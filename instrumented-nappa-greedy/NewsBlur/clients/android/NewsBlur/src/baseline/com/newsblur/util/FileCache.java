...
public class FileCache {
    ...
    public void cleanupOld(long maxFileAgeMillis) {
        try {
            ...
            baseline.com.newsblur.util.Log.i(this, String.format( "have %d files", files.length));
            for (File f : files) {
            ...
            baseline.com.newsblur.util.Log.i(this, String.format( "cleaned up %d files", cleaned));
        } catch (Exception e) {
            baseline.com.newsblur.util.Log.e(this, "exception cleaning up cache", e);
        }
    }
