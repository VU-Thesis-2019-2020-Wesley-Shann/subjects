...
import nappagreedy.com.newsblur.fragment.FeedIntelligenceSelectorFragment;
import nappagreedy.com.newsblur.fragment.FolderListFragment;
import nappagreedy.com.newsblur.fragment.LoginAsDialogFragment;
import nappagreedy.com.newsblur.fragment.LogoutDialogFragment;
import nappagreedy.com.newsblur.fragment.TextSizeDialogFragment;
import nappagreedy.com.newsblur.service.BootReceiver;
...
public class Main extends NbActivity implements StateChangedListener, SwipeRefreshLayout.OnRefreshListener, AbsListView.OnScrollListener, PopupMenu.OnMenuItemClickListener, OnSeekBarChangeListener {
    ...
    protected void onResume() {
        try {
            ...
            nappagreedy.com.newsblur.util.Log.e(getClass().getName(), "error resuming Main", e);
            finish();
        }
