...
public class UnreadsService extends SubService {
    ...
    private void syncUnreadList() {
        ...
        nappagreedy.com.newsblur.util.Log.i(this, "starting unread count: " + oldUnreadHashes.size());
        ...
        nappagreedy.com.newsblur.util.Log.i(this, "new unread count:      " + count);
        nappagreedy.com.newsblur.util.Log.i(this, "new unreads found:     " + sortationList.size());
        nappagreedy.com.newsblur.util.Log.i(this, "unreads to retire:     " + oldUnreadHashes.size());
    ...
    private void getNewUnreadStories() {
        ...
        unreadsyncloop: while (StoryHashQueue.size() > 0) {
            ...
            if (! isStoryResponseGood(response)) {
                nappagreedy.com.newsblur.util.Log.e(this, "error fetching unreads batch, abandoning sync.");
    ...
    private boolean isStoryResponseGood(StoriesResponse response) {
        if (response == null) {
            nappagreedy.com.newsblur.util.Log.e(this, "Null response received while loading stories.");
            return false;
        }
        if (response.stories == null) {
            nappagreedy.com.newsblur.util.Log.e(this, "Null stories member received while loading stories.");
            return false;
        }
        return true;
    }
