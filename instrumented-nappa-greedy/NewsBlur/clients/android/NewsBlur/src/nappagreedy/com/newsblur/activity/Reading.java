...
import nappagreedy.com.newsblur.database.ReadingAdapter;
import nappagreedy.com.newsblur.domain.Story;
import nappagreedy.com.newsblur.fragment.ReadingItemFragment;
import nappagreedy.com.newsblur.fragment.ReadingPagerFragment;
...
import nappagreedy.com.newsblur.util.ReadingFontChangedListener;
...
public abstract class Reading extends NbActivity implements OnPageChangeListener, OnSeekBarChangeListener, ScrollChangeListener, LoaderManager.LoaderCallbacks<Cursor>, ReadingFontChangedListener {
	...
	protected void onCreate(Bundle savedInstanceBundle) {
        ...
        try {
            ...
            // Serializable extras.
            nappagreedy.com.newsblur.util.Log.e(this, "failed to unfreeze required extras", re);
            finish();
            return;
        }

        if (fs == null) {
            nappagreedy.com.newsblur.util.Log.w(this.getClass().getName(), "reading view had no FeedSet");
            finish();
            return;
        }
	...
	public void onLoadFinished(Loader<Cursor> loader, Cursor cursor) {
        synchronized (STORIES_MUTEX) {
            ...
            if (! FeedUtils.dbHelper.isFeedSetReady(fs)) {
                nappagreedy.com.newsblur.util.Log.i(this.getClass().getName(), "stale load");
            ...
            nappagreedy.com.newsblur.util.Log.d(this.getClass().getName(), "loaded cursor with count: " + cursor.getCount());
