...
import nappagreedy.com.newsblur.activity.AllSharedStoriesItemsList;
import nappagreedy.com.newsblur.activity.AllStoriesItemsList;
import nappagreedy.com.newsblur.activity.FeedItemsList;
import nappagreedy.com.newsblur.activity.FolderItemsList;
import nappagreedy.com.newsblur.activity.GlobalSharedStoriesItemsList;
import nappagreedy.com.newsblur.activity.InfrequentItemsList;
import nappagreedy.com.newsblur.activity.ItemsList;
import nappagreedy.com.newsblur.activity.Main;
import nappagreedy.com.newsblur.activity.NbActivity;
import nappagreedy.com.newsblur.activity.ReadStoriesItemsList;
import nappagreedy.com.newsblur.activity.SavedStoriesItemsList;
import nappagreedy.com.newsblur.activity.SocialFeedItemsList;
import nappagreedy.com.newsblur.database.FolderListAdapter;
...
public class FolderListFragment extends NbFragment implements OnCreateContextMenuListener, 
	...
	public void hasUpdated() {
        if (isAdded()) {
            nappagreedy.com.newsblur.util.Log.d(this, "loading feeds in mode: " + currentState);
            try {
    ...
    public void pushUnreadCounts() {
        ...
        nappagreedy.com.newsblur.util.Log.d(this, "showing " + adapter.lastFeedCount + " feeds");
    }
