...
import nappagreedy.com.newsblur.service.OriginalTextService;
...
public class ReadingItemFragment extends NbFragment implements PopupMenu.OnMenuItemClickListener {
    ...
    public void offerStoryUpdate(Story story) {
        ...
        if (! TextUtils.equals(story.storyHash, this.story.storyHash)) {
            nappagreedy.com.newsblur.util.Log.d(this, "prevented story list index offset shift");
            return;
        }
        this.story = story;
        //if (AppConstants.VERBOSE_LOG) nappagreedy.com.newsblur.util.Log.d(this, "got fresh story");
    }
                ...
                protected void onPostExecute(String result) {
                    if (result != null) {
                        if (OriginalTextService.NULL_STORY_TEXT.equals(result)) {
                            ...
                            nappagreedy.com.newsblur.util.Log.d(this, "orig text not avail for story: " + story.storyHash);
                        ...
                        nappagreedy.com.newsblur.util.Log.d(this, "orig text not yet cached for story: " + story.storyHash);
        ...
        new AsyncTask<Void, Void, String>() {
            ...
            protected void onPostExecute(String result) {
                if (result != null) {
                    ...
                    nappagreedy.com.newsblur.util.Log.w(this, "couldn't find story content for existing story.");
