...
import nappagreedy.com.newsblur.fragment.ReadingActionConfirmationFragment;
...
public class FeedUtils {
    ...
    private static void setStoryReadState(Story story, Context context, boolean read) {
        try {
            ...
            nappagreedy.com.newsblur.util.Log.e(FeedUtils.class.getName(), "error touching story state in DB", e);
        }
        ...
        if (fs.isAllNormal() && (olderThan != null || newerThan != null)) {
            ...
            if (fs.getSingleFeed() != null) {
                if (!fs.isMuted()) {
                    ...
                    nappagreedy.com.newsblur.util.Log.w(activity, "disregarding mark-read for muted feed.");
                    return;
                }
            } else if (fs.isFolder()) {
