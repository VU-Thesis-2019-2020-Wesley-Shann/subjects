...
package baseline.org.quantumbadger.redreader.image;
...
import baseline.org.quantumbadger.redreader.activities.BaseActivity;
				...
				CacheManager.getInstance(activity).makeRequest(new CacheRequest(
					...
					protected void onSuccess(
						...
						Uri sharedImage = FileProvider.getUriForFile(
								context,
								"baseline.org.quantumbadger.redreader.provider",
								dst
						);
