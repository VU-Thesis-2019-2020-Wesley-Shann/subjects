...
import nappagreedy.de.danoeh.antennapod.menuhandler.FeedItemMenuHandler;
import nappagreedy.de.danoeh.antennapod.menuhandler.FeedMenuHandler;
import nappagreedy.de.danoeh.antennapod.R;
import nappagreedy.de.danoeh.antennapod.activity.FeedInfoActivity;
import nappagreedy.de.danoeh.antennapod.activity.FeedSettingsActivity;
import nappagreedy.de.danoeh.antennapod.activity.MainActivity;
import nappagreedy.de.danoeh.antennapod.adapter.FeedItemlistAdapter;
import nappagreedy.de.danoeh.antennapod.core.asynctask.FeedRemover;
import nappagreedy.de.danoeh.antennapod.core.dialog.ConfirmationDialog;
import nappagreedy.de.danoeh.antennapod.core.dialog.DownloadRequestErrorDialogCreator;
import nappagreedy.de.danoeh.antennapod.core.event.DownloadEvent;
import nappagreedy.de.danoeh.antennapod.core.event.DownloaderUpdate;
import nappagreedy.de.danoeh.antennapod.core.event.FeedItemEvent;
import nappagreedy.de.danoeh.antennapod.core.feed.EventDistributor;
import nappagreedy.de.danoeh.antennapod.core.feed.Feed;
import nappagreedy.de.danoeh.antennapod.core.feed.FeedEvent;
import nappagreedy.de.danoeh.antennapod.core.feed.FeedItem;
import nappagreedy.de.danoeh.antennapod.core.feed.FeedItemFilter;
...
import nappagreedy.de.danoeh.antennapod.core.glide.FastBlurTransformation;
import nappagreedy.de.danoeh.antennapod.core.service.download.DownloadService;
...
import nappagreedy.de.danoeh.antennapod.core.storage.DownloadRequestException;
import nappagreedy.de.danoeh.antennapod.core.storage.DownloadRequester;
import nappagreedy.de.danoeh.antennapod.core.util.FeedItemUtil;
import nappagreedy.de.danoeh.antennapod.core.util.LongList;
import nappagreedy.de.danoeh.antennapod.core.util.Optional;
import nappagreedy.de.danoeh.antennapod.core.util.gui.MoreContentListFooterUtil;
import nappagreedy.de.danoeh.antennapod.dialog.EpisodesApplyActionFragment;
import nappagreedy.de.danoeh.antennapod.dialog.RenameFeedDialog;
...
public class ItemlistFragment extends ListFragment {
    ...
    private final MenuItemUtils.UpdateRefreshMenuItemChecker updateRefreshMenuItemChecker = new nappagreedy.de.danoeh.antennapod.menuhandler.MenuItemUtils.UpdateRefreshMenuItemChecker() {
        @Override
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        ...
        if (itemsLoaded) {
            ...
            nappagreedy.de.danoeh.antennapod.menuhandler.MenuItemUtils.adjustTextColor(getActivity(), sv);
            ...
            isUpdatingFeed = nappagreedy.de.danoeh.antennapod.menuhandler.MenuItemUtils.updateRefreshMenuItem(menu, R.id.refresh_item, updateRefreshMenuItemChecker);
        }
    }
