package baseline.de.danoeh.antennapod.fragment;
...
import baseline.de.danoeh.antennapod.menuhandler.FeedItemMenuHandler;
import baseline.de.danoeh.antennapod.menuhandler.FeedMenuHandler;
import baseline.de.danoeh.antennapod.R;
import baseline.de.danoeh.antennapod.activity.FeedInfoActivity;
import baseline.de.danoeh.antennapod.activity.FeedSettingsActivity;
import baseline.de.danoeh.antennapod.activity.MainActivity;
import baseline.de.danoeh.antennapod.adapter.FeedItemlistAdapter;
import baseline.de.danoeh.antennapod.core.asynctask.FeedRemover;
import baseline.de.danoeh.antennapod.core.dialog.ConfirmationDialog;
import baseline.de.danoeh.antennapod.core.dialog.DownloadRequestErrorDialogCreator;
import baseline.de.danoeh.antennapod.core.event.DownloadEvent;
import baseline.de.danoeh.antennapod.core.event.DownloaderUpdate;
import baseline.de.danoeh.antennapod.core.event.FeedItemEvent;
import baseline.de.danoeh.antennapod.core.feed.EventDistributor;
import baseline.de.danoeh.antennapod.core.feed.Feed;
import baseline.de.danoeh.antennapod.core.feed.FeedEvent;
import baseline.de.danoeh.antennapod.core.feed.FeedItem;
import baseline.de.danoeh.antennapod.core.feed.FeedItemFilter;
import baseline.de.danoeh.antennapod.core.feed.FeedMedia;
import baseline.de.danoeh.antennapod.core.glide.ApGlideSettings;
import baseline.de.danoeh.antennapod.core.glide.FastBlurTransformation;
import baseline.de.danoeh.antennapod.core.service.download.DownloadService;
...
import baseline.de.danoeh.antennapod.core.util.FeedItemUtil;
import baseline.de.danoeh.antennapod.core.util.LongList;
import baseline.de.danoeh.antennapod.core.util.Optional;
import baseline.de.danoeh.antennapod.core.util.gui.MoreContentListFooterUtil;
import baseline.de.danoeh.antennapod.dialog.EpisodesApplyActionFragment;
import baseline.de.danoeh.antennapod.dialog.RenameFeedDialog;
...
public class ItemlistFragment extends ListFragment {
    ...
    private final MenuItemUtils.UpdateRefreshMenuItemChecker updateRefreshMenuItemChecker = new baseline.de.danoeh.antennapod.menuhandler.MenuItemUtils.UpdateRefreshMenuItemChecker() {
        @Override
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        ...
        if (itemsLoaded) {
            ...
            baseline.de.danoeh.antennapod.menuhandler.MenuItemUtils.adjustTextColor(getActivity(), sv);
            ...
            isUpdatingFeed = baseline.de.danoeh.antennapod.menuhandler.MenuItemUtils.updateRefreshMenuItem(menu, R.id.refresh_item, updateRefreshMenuItemChecker);
        }
    }
