package nappagreedy.de.danoeh.antennapod.core.util.playback;
...
import nappagreedy.de.danoeh.antennapod.core.event.ServiceEvent;
...
import nappagreedy.de.danoeh.antennapod.core.util.playback.Playable.PlayableUtils;
        ...
        mediaLoader = Maybe.create((MaybeOnSubscribe<Playable>) emitter -> {
            ...
            .subscribe(media -> {
                if (media.getMediaType() == MediaType.AUDIO) {
                    TypedArray res = activity.obtainStyledAttributes(new int[]{
                            nappagreedy.de.danoeh.antennapod.core.R.attr.av_play_big});
                    getPlayButton().setImageResource(
                            res.getResourceId(0, nappagreedy.de.danoeh.antennapod.core.R.drawable.ic_play_arrow_grey600_36dp));
                    res.recycle();
                } else {
