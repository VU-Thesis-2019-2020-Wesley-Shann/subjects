...
public class PlaybackPreferences implements SharedPreferences.OnSharedPreferenceChangeListener {
     ...
     * object.
     */
    public static final String PREF_CURRENTLY_PLAYING_FEED_ID = "baseline.de.danoeh.antennapod.preferences.lastPlayedFeedId";
     ...
     */
    public static final String PREF_CURRENTLY_PLAYING_FEEDMEDIA_ID = "baseline.de.danoeh.antennapod.preferences.lastPlayedFeedMediaId";
     ...
     */
    public static final String PREF_CURRENTLY_PLAYING_MEDIA = "baseline.de.danoeh.antennapod.preferences.currentlyPlayingMedia";

    /**
     * True if last played media was streamed.
     */
    public static final String PREF_CURRENT_EPISODE_IS_STREAM = "baseline.de.danoeh.antennapod.preferences.lastIsStream";

    /**
     * True if last played media was a video.
     */
    public static final String PREF_CURRENT_EPISODE_IS_VIDEO = "baseline.de.danoeh.antennapod.preferences.lastIsVideo";

    /**
     * The current player status as int.
     */
    public static final String PREF_CURRENT_PLAYER_STATUS = "baseline.de.danoeh.antennapod.preferences.currentPlayerStatus";
