...
import baseline.de.danoeh.antennapod.core.gpoddernet.GpodnetServiceAuthenticationException;
...
import baseline.de.danoeh.antennapod.core.gpoddernet.model.GpodnetEpisodeActionGetResponse;
import baseline.de.danoeh.antennapod.core.gpoddernet.model.GpodnetEpisodeActionPostResponse;
import baseline.de.danoeh.antennapod.core.gpoddernet.model.GpodnetSubscriptionChange;
import baseline.de.danoeh.antennapod.core.gpoddernet.model.GpodnetUploadChangesResponse;
...
public class GpodnetSyncService extends SafeJobIntentService {
    ...
    private static final String ACTION_SYNC = "baseline.de.danoeh.antennapod.intent.action.sync";
    private static final String ACTION_SYNC_SUBSCRIPTIONS = "baseline.de.danoeh.antennapod.intent.action.sync_subscriptions";
    private static final String ACTION_SYNC_ACTIONS = "baseline.de.danoeh.antennapod.intent.action.sync_ACTIONS";
