...
import baseline.de.danoeh.antennapod.core.cast.CastConsumer;
import baseline.de.danoeh.antennapod.core.cast.CastManager;
import baseline.de.danoeh.antennapod.core.cast.CastUtils;
import baseline.de.danoeh.antennapod.core.cast.DefaultCastConsumer;
...
import baseline.de.danoeh.antennapod.core.util.RewindAfterPauseUtils;
...
public class RemotePSMP extends PlaybackServiceMediaPlayer {
     ...
     *
     * @see #playMediaObject(baseline.de.danoeh.antennapod.core.util.playback.Playable, boolean, boolean, boolean)
     */
