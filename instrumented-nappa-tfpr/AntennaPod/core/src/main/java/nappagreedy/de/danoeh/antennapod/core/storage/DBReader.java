...
import nappagreedy.de.danoeh.antennapod.core.util.LongIntMap;
import nappagreedy.de.danoeh.antennapod.core.util.LongList;
import nappagreedy.de.danoeh.antennapod.core.util.comparator.DownloadStatusComparator;
import nappagreedy.de.danoeh.antennapod.core.util.comparator.FeedItemPubdateComparator;
import nappagreedy.de.danoeh.antennapod.core.util.comparator.PlaybackCompletionDateComparator;
 ...
 * This class will use the {@link nappagreedy.de.danoeh.antennapod.core.feed.EventDistributor} to notify listeners about changes in the database.
 */
public final class DBReader {
     ...
     * list in a {@link nappagreedy.de.danoeh.antennapod.core.util.QueueAccess} object for easier access to the queue's properties.
     */
