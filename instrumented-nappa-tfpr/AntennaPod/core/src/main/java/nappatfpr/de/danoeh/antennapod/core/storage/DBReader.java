...
import nappatfpr.de.danoeh.antennapod.core.util.LongIntMap;
import nappatfpr.de.danoeh.antennapod.core.util.LongList;
import nappatfpr.de.danoeh.antennapod.core.util.comparator.DownloadStatusComparator;
import nappatfpr.de.danoeh.antennapod.core.util.comparator.FeedItemPubdateComparator;
import nappatfpr.de.danoeh.antennapod.core.util.comparator.PlaybackCompletionDateComparator;
 ...
 * This class will use the {@link nappatfpr.de.danoeh.antennapod.core.feed.EventDistributor} to notify listeners about changes in the database.
 */
public final class DBReader {
     ...
     * list in a {@link nappatfpr.de.danoeh.antennapod.core.util.QueueAccess} object for easier access to the queue's properties.
     */
