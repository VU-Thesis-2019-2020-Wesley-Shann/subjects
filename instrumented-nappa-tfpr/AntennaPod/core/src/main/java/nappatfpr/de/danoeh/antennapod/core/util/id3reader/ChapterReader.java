package nappatfpr.de.danoeh.antennapod.core.util.id3reader;
...
import nappatfpr.de.danoeh.antennapod.core.feed.ID3Chapter;
import nappatfpr.de.danoeh.antennapod.core.util.id3reader.model.FrameHeader;
import nappatfpr.de.danoeh.antennapod.core.util.id3reader.model.TagHeader;
