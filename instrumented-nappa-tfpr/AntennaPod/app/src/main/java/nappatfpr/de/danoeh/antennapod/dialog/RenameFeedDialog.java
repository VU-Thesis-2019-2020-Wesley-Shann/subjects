package nappatfpr.de.danoeh.antennapod.dialog;
...
public class RenameFeedDialog {
    ...
    public void show() {
        ...
        new MaterialDialog.Builder(activity)
                .title(nappatfpr.de.danoeh.antennapod.core.R.string.rename_feed_label)
                ...
                .neutralText(nappatfpr.de.danoeh.antennapod.core.R.string.reset)
                .onNeutral((dialog, which) -> dialog.getInputEditText().setText(feed.getFeedTitle()))
                .negativeText(nappatfpr.de.danoeh.antennapod.core.R.string.cancel_label)
