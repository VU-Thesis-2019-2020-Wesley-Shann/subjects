...
import nappatfpr.de.danoeh.antennapod.adapter.QueueRecyclerAdapter;
...
public class QueueFragment extends Fragment {
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        ...
        if (queue != null) {
            ...
            nappatfpr.de.danoeh.antennapod.menuhandler.MenuItemUtils.refreshLockItem(getActivity(), menu);

            isUpdatingFeeds = nappatfpr.de.danoeh.antennapod.menuhandler.MenuItemUtils.updateRefreshMenuItem(menu, R.id.refresh_item, updateRefreshMenuItemChecker);
        }
    }
