...
import nappatfpr.de.danoeh.antennapod.menuhandler.FeedItemMenuHandler;
import nappatfpr.de.danoeh.antennapod.menuhandler.FeedMenuHandler;
import nappatfpr.de.danoeh.antennapod.R;
import nappatfpr.de.danoeh.antennapod.activity.FeedInfoActivity;
import nappatfpr.de.danoeh.antennapod.activity.FeedSettingsActivity;
import nappatfpr.de.danoeh.antennapod.activity.MainActivity;
import nappatfpr.de.danoeh.antennapod.adapter.FeedItemlistAdapter;
import nappatfpr.de.danoeh.antennapod.core.asynctask.FeedRemover;
import nappatfpr.de.danoeh.antennapod.core.dialog.ConfirmationDialog;
import nappatfpr.de.danoeh.antennapod.core.dialog.DownloadRequestErrorDialogCreator;
import nappatfpr.de.danoeh.antennapod.core.event.DownloadEvent;
import nappatfpr.de.danoeh.antennapod.core.event.DownloaderUpdate;
import nappatfpr.de.danoeh.antennapod.core.event.FeedItemEvent;
import nappatfpr.de.danoeh.antennapod.core.feed.EventDistributor;
import nappatfpr.de.danoeh.antennapod.core.feed.Feed;
import nappatfpr.de.danoeh.antennapod.core.feed.FeedEvent;
import nappatfpr.de.danoeh.antennapod.core.feed.FeedItem;
import nappatfpr.de.danoeh.antennapod.core.feed.FeedItemFilter;
...
import nappatfpr.de.danoeh.antennapod.core.glide.FastBlurTransformation;
import nappatfpr.de.danoeh.antennapod.core.service.download.DownloadService;
import nappatfpr.de.danoeh.antennapod.core.service.download.Downloader;
import nappatfpr.de.danoeh.antennapod.core.storage.DBReader;
import nappatfpr.de.danoeh.antennapod.core.storage.DBTasks;
import nappatfpr.de.danoeh.antennapod.core.storage.DownloadRequestException;
import nappatfpr.de.danoeh.antennapod.core.storage.DownloadRequester;
import nappatfpr.de.danoeh.antennapod.core.util.FeedItemUtil;
import nappatfpr.de.danoeh.antennapod.core.util.LongList;
import nappatfpr.de.danoeh.antennapod.core.util.Optional;
import nappatfpr.de.danoeh.antennapod.core.util.gui.MoreContentListFooterUtil;
import nappatfpr.de.danoeh.antennapod.dialog.EpisodesApplyActionFragment;
import nappatfpr.de.danoeh.antennapod.dialog.RenameFeedDialog;
import nappatfpr.de.danoeh.antennapod.menuhandler.MenuItemUtils;
...
public class ItemlistFragment extends ListFragment {
    ...
    private final MenuItemUtils.UpdateRefreshMenuItemChecker updateRefreshMenuItemChecker = new nappatfpr.de.danoeh.antennapod.menuhandler.MenuItemUtils.UpdateRefreshMenuItemChecker() {
        @Override
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        ...
        if (itemsLoaded) {
            ...
            nappatfpr.de.danoeh.antennapod.menuhandler.MenuItemUtils.adjustTextColor(getActivity(), sv);
            ...
            isUpdatingFeed = nappatfpr.de.danoeh.antennapod.menuhandler.MenuItemUtils.updateRefreshMenuItem(menu, R.id.refresh_item, updateRefreshMenuItemChecker);
        }
    }
