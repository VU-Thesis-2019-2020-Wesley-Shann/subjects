package nappagreedy.de.danoeh.antennapod.adapter;
...
import nappagreedy.de.danoeh.antennapod.fragment.AllEpisodesFragment;
...
import nappagreedy.de.danoeh.antennapod.fragment.NewEpisodesFragment;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (v != null && viewType != VIEW_TYPE_SECTION_DIVIDER) {
            ...
            if (position == itemAccess.getSelectedItemIndex()) {
                ...
                v.getContext().getTheme().resolveAttribute(nappagreedy.de.danoeh.antennapod.core.R.attr.drawer_activated_color, typedValue, true);
                v.setBackgroundResource(typedValue.resourceId);

            } else {
                txtvTitle.setTypeface(null, Typeface.NORMAL);
                v.getContext().getTheme().resolveAttribute(nappagreedy.de.danoeh.antennapod.core.R.attr.nav_drawer_background, typedValue, true);
                v.setBackgroundResource(typedValue.resourceId);
            }
        }
        return v;
