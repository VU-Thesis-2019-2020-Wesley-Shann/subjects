...
import nappatfpr.com.newsblur.activity.AllSharedStoriesItemsList;
import nappatfpr.com.newsblur.activity.AllStoriesItemsList;
import nappatfpr.com.newsblur.activity.FeedItemsList;
import nappatfpr.com.newsblur.activity.FolderItemsList;
import nappatfpr.com.newsblur.activity.GlobalSharedStoriesItemsList;
import nappatfpr.com.newsblur.activity.InfrequentItemsList;
import nappatfpr.com.newsblur.activity.ItemsList;
import nappatfpr.com.newsblur.activity.Main;
import nappatfpr.com.newsblur.activity.NbActivity;
import nappatfpr.com.newsblur.activity.ReadStoriesItemsList;
import nappatfpr.com.newsblur.activity.SavedStoriesItemsList;
import nappatfpr.com.newsblur.activity.SocialFeedItemsList;
import nappatfpr.com.newsblur.database.FolderListAdapter;
...
public class FolderListFragment extends NbFragment implements OnCreateContextMenuListener, 
	...
	public void hasUpdated() {
        if (isAdded()) {
            nappatfpr.com.newsblur.util.Log.d(this, "loading feeds in mode: " + currentState);
            try {
    ...
    public void pushUnreadCounts() {
        ...
        nappatfpr.com.newsblur.util.Log.d(this, "showing " + adapter.lastFeedCount + " feeds");
    }
