...
import nappatfpr.com.newsblur.database.StoryViewAdapter;
...
import nappatfpr.com.newsblur.util.StoryListStyle;
...
public class ItemSetFragment extends NbFragment implements LoaderManager.LoaderCallbacks<Cursor> {
	...
	public Loader<Cursor> onCreateLoader(int arg0, Bundle arg1) {
        ...
        if (fs == null) {
            nappatfpr.com.newsblur.util.Log.e(this.getClass().getName(), "can't create fragment, no feedset ready");
    ...
    private void ensureSufficientStories() {
        ...
        //nappatfpr.com.newsblur.util.Log.d(this, String.format(" total:%d  bound:%d  last%d  desire:%d", totalCount, visibleCount, lastVisible, desiredStoryCount));
    }
