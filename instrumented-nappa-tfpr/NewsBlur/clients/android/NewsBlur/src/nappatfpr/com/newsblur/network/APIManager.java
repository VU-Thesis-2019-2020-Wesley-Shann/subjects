package nappatfpr.com.newsblur.network;
...
import nappatfpr.com.newsblur.domain.Classifier;
import nappatfpr.com.newsblur.domain.Feed;
import nappatfpr.com.newsblur.domain.FeedResult;
import nappatfpr.com.newsblur.domain.Story;
import nappatfpr.com.newsblur.domain.ValueMultimap;
import static nappatfpr.com.newsblur.network.APIConstants.buildUrl;
import nappatfpr.com.newsblur.network.domain.ActivitiesResponse;
import nappatfpr.com.newsblur.network.domain.AddFeedResponse;
import nappatfpr.com.newsblur.network.domain.CommentResponse;
import nappatfpr.com.newsblur.network.domain.FeedFolderResponse;
import nappatfpr.com.newsblur.network.domain.InteractionsResponse;
import nappatfpr.com.newsblur.network.domain.LoginResponse;
import nappatfpr.com.newsblur.network.domain.NewsBlurResponse;
import nappatfpr.com.newsblur.network.domain.ProfileResponse;
import nappatfpr.com.newsblur.network.domain.RegisterResponse;
import nappatfpr.com.newsblur.network.domain.StoriesResponse;
import nappatfpr.com.newsblur.network.domain.StoryTextResponse;
import nappatfpr.com.newsblur.network.domain.UnreadCountResponse;
import nappatfpr.com.newsblur.network.domain.UnreadStoryHashesResponse;
import nappatfpr.com.newsblur.serialization.BooleanTypeAdapter;
import nappatfpr.com.newsblur.serialization.ClassifierMapTypeAdapter;
import nappatfpr.com.newsblur.serialization.DateStringTypeAdapter;
import nappatfpr.com.newsblur.serialization.FeedListTypeAdapter;
import nappatfpr.com.newsblur.serialization.StoryTypeAdapter;
...
public class APIManager {
	...
	public LoginResponse login(final String username, final String password) {
        ...
        nappatfpr.com.newsblur.util.Log.i(this.getClass().getName(), "calling login API");
    ...
    public boolean loginAs(String username) {
        ...
        nappatfpr.com.newsblur.util.Log.i(this.getClass().getName(), "doing superuser swap: " + urlString);
    ...
    private void backoffSleep(int tryCount) {
        ...
        nappatfpr.com.newsblur.util.Log.i(this.getClass().getName(), "API call failed, pausing before retry number " + tryCount);
        try {
            ...
            nappatfpr.com.newsblur.util.Log.w(this.getClass().getName(), "Abandoning API backoff due to interrupt.");
        }
    }
