...
public class BootReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        nappatfpr.com.newsblur.util.Log.d(this, "triggering sync service from device boot");
        scheduleSyncService(context);
    }

    public static void scheduleSyncService(Context context) {
        nappatfpr.com.newsblur.util.Log.d(BootReceiver.class.getName(), "scheduling sync service");
