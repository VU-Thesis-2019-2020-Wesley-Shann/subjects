...
import nappatfpr.com.newsblur.fragment.FeedIntelligenceSelectorFragment;
import nappatfpr.com.newsblur.fragment.FolderListFragment;
import nappatfpr.com.newsblur.fragment.LoginAsDialogFragment;
import nappatfpr.com.newsblur.fragment.LogoutDialogFragment;
import nappatfpr.com.newsblur.fragment.TextSizeDialogFragment;
import nappatfpr.com.newsblur.service.BootReceiver;
...
import nappatfpr.com.newsblur.view.StateToggleButton.StateChangedListener;
...
public class Main extends NbActivity implements StateChangedListener, SwipeRefreshLayout.OnRefreshListener, AbsListView.OnScrollListener, PopupMenu.OnMenuItemClickListener, OnSeekBarChangeListener {
    ...
    protected void onResume() {
        try {
            ...
            nappatfpr.com.newsblur.util.Log.e(getClass().getName(), "error resuming Main", e);
            finish();
        }
