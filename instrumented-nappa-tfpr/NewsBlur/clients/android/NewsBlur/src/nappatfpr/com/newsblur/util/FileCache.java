...
public class FileCache {
    ...
    public void cleanupOld(long maxFileAgeMillis) {
        try {
            ...
            nappatfpr.com.newsblur.util.Log.i(this, String.format( "have %d files", files.length));
            for (File f : files) {
            ...
            nappatfpr.com.newsblur.util.Log.i(this, String.format( "cleaned up %d files", cleaned));
        } catch (Exception e) {
            nappatfpr.com.newsblur.util.Log.e(this, "exception cleaning up cache", e);
        }
    }
