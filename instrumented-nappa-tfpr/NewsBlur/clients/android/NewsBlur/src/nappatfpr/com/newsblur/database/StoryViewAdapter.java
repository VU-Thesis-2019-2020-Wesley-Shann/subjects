...
import nappatfpr.com.newsblur.fragment.StoryIntelTrainerFragment;
import nappatfpr.com.newsblur.util.FeedSet;
import nappatfpr.com.newsblur.util.FeedUtils;
import nappatfpr.com.newsblur.util.GestureAction;
import nappatfpr.com.newsblur.util.ImageLoader;
...
public class StoryViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private void thawDiffUpdate(final Cursor c, final RecyclerView rv) {
        ...
        try {
            ...
            nappatfpr.com.newsblur.util.Log.e(this, "error thawing story list: " + e.getMessage(), e);
            return;
        }
