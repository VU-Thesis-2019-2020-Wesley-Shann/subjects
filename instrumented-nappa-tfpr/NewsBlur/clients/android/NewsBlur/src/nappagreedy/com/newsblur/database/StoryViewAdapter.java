...
import nappagreedy.com.newsblur.fragment.ItemSetFragment;
import nappagreedy.com.newsblur.fragment.StoryIntelTrainerFragment;
import nappagreedy.com.newsblur.util.FeedSet;
import nappagreedy.com.newsblur.util.FeedUtils;
import nappagreedy.com.newsblur.util.GestureAction;
import nappagreedy.com.newsblur.util.ImageLoader;
...
public class StoryViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private void thawDiffUpdate(final Cursor c, final RecyclerView rv) {
        ...
        try {
            ...
            nappagreedy.com.newsblur.util.Log.e(this, "error thawing story list: " + e.getMessage(), e);
            return;
        }
