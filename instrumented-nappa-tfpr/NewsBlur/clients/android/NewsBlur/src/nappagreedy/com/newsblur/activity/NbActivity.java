...
public class NbActivity extends FragmentActivity {
	...
	protected void onCreate(Bundle bundle) {
        ...
        if (PrefsUtils.getUserId(this) == null) {
            nappagreedy.com.newsblur.util.Log.e(this, "post-login activity launched without valid login.");
	...
	protected void onResume() {
        nappagreedy.com.newsblur.util.Log.d(this, "onResume" + UIUtils.getMemoryUsageDebug(this));
		super.onResume();
		finishIfNotLoggedIn();
	...
	protected void onPause() {
        nappagreedy.com.newsblur.util.Log.d(this.getClass().getName(), "onPause");
		super.onPause();
	...
	protected void finishIfNotLoggedIn() {
		...
		if(currentLoginKey == null || !currentLoginKey.equals(uniqueLoginKey)) {
			nappagreedy.com.newsblur.util.Log.d(this.getClass().getName(), "This activity was for a different login. finishing it.");
			finish();
		}
	}
	...
	protected void onSaveInstanceState(Bundle savedInstanceState) {
        nappagreedy.com.newsblur.util.Log.d(this, "onSave");
    ...
    protected void handleUpdate(int updateType) {
        nappagreedy.com.newsblur.util.Log.w(this, "activity doesn't implement handleUpdate");
    }
