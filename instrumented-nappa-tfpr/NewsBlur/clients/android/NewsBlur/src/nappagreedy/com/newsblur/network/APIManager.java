package nappagreedy.com.newsblur.network;
...
import nappagreedy.com.newsblur.domain.FeedResult;
import nappagreedy.com.newsblur.domain.Story;
import nappagreedy.com.newsblur.domain.ValueMultimap;
import static nappagreedy.com.newsblur.network.APIConstants.buildUrl;
...
import nappagreedy.com.newsblur.network.domain.ProfileResponse;
...
import nappagreedy.com.newsblur.network.domain.StoryTextResponse;
import nappagreedy.com.newsblur.network.domain.UnreadCountResponse;
import nappagreedy.com.newsblur.network.domain.UnreadStoryHashesResponse;
import nappagreedy.com.newsblur.serialization.BooleanTypeAdapter;
import nappagreedy.com.newsblur.serialization.ClassifierMapTypeAdapter;
import nappagreedy.com.newsblur.serialization.DateStringTypeAdapter;
import nappagreedy.com.newsblur.serialization.FeedListTypeAdapter;
import nappagreedy.com.newsblur.serialization.StoryTypeAdapter;
...
public class APIManager {
	...
	public LoginResponse login(final String username, final String password) {
        ...
        nappagreedy.com.newsblur.util.Log.i(this.getClass().getName(), "calling login API");
    ...
    public boolean loginAs(String username) {
        ...
        nappagreedy.com.newsblur.util.Log.i(this.getClass().getName(), "doing superuser swap: " + urlString);
    ...
    private void backoffSleep(int tryCount) {
        ...
        nappagreedy.com.newsblur.util.Log.i(this.getClass().getName(), "API call failed, pausing before retry number " + tryCount);
        try {
            ...
            nappagreedy.com.newsblur.util.Log.w(this.getClass().getName(), "Abandoning API backoff due to interrupt.");
        }
    }
