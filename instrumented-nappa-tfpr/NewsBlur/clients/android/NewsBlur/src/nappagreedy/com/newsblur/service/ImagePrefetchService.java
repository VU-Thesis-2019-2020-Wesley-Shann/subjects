    ...
    protected void exec() {
        ...
        try {
            ...
            while (StoryImageQueue.size() > 0) {
                ...
                startExpensiveCycle();
                nappagreedy.com.newsblur.util.Log.d(this, "story images to prefetch: " + StoryImageQueue.size());
                ...
                try {
                    ...
                    nappagreedy.com.newsblur.util.Log.d(this, "story images fetched: " + fetchedImages.size());
                }
            }
            ...
            while (ThumbnailQueue.size() > 0) {
                ...
                startExpensiveCycle();
                nappagreedy.com.newsblur.util.Log.d(this, "story thumbs to prefetch: " + StoryImageQueue.size());
                // on each batch, re-query the DB for images associated with yet-unread stories
                // this is a bit expensive, but we are running totally async at a really low priority
                ...
                try {
                    ...
                    nappagreedy.com.newsblur.util.Log.d(this, "story thumbs fetched: " + fetchedImages.size());
                }
            }
        } finally {
