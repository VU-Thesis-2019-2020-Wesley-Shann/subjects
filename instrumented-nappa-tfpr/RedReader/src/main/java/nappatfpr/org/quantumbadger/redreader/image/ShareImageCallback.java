...
package nappatfpr.org.quantumbadger.redreader.image;
...
import nappatfpr.org.quantumbadger.redreader.activities.BaseActivity;
				...
				CacheManager.getInstance(activity).makeRequest(new CacheRequest(
					...
					protected void onSuccess(
						...
						Uri sharedImage = FileProvider.getUriForFile(
								context,
								"nappatfpr.org.quantumbadger.redreader.provider",
								dst
						);
